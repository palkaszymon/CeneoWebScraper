...
class Product:
    ...
    def __str__(self):
        return f"""The product name: {self.product_name}
The product id is {self.product_id}
number of opinions:{self.opinions_count}
number of pros:{self.pros_count}
number of cons:{self.cons_count}
the average score:{self.average_score}"""
